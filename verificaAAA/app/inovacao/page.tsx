      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-center text-gray-600 mb-12 max-w-2xl mx-auto">
            Elementos únicos e criativos que diferenciam nosso projeto
          </p>
          ...
          <Card className="shadow-2xl border border-gray-200/50 bg-white backdrop-blur-sm relative overflow-hidden">
            ...
            <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-yellow-500 to-amber-400"></div>
            <CardContent className="p-8 md:p-12 relative z-10">
              <p className="text-lg leading-relaxed text-gray-700">
                Nosso projeto incorpora soluções inovadoras e pensamento criativo para abordar problemas complexos.
                Exploramos novas possibilidades e desafiamos paradigmas estabelecidos, sempre mantendo o rigor
                acadêmico.
              </p>
            </CardContent>
          </Card>
