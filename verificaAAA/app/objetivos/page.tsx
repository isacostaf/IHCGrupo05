      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-center text-gray-600 mb-12 max-w-2xl mx-auto">
            Metas claras e ambiciosas que norteiam nosso trabalho
          </p>
          ...
          <Card className="shadow-2xl border border-gray-200/50 bg-white backdrop-blur-sm relative overflow-hidden">
            ...
            <CardContent className="p-8 md:p-12 relative z-10">
              <p className="text-lg leading-relaxed text-gray-700">
                Estabelecemos objetivos específicos, mensuráveis e alcançáveis que servem como bússola para nossas
                atividades. Cada meta foi cuidadosamente planejada para maximizar o impacto e a relevância do nosso
                projeto.
              </p>
            </CardContent>
          </Card>
